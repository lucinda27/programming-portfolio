...
void setup() {
  ...
  opButtons[12] = new Button(0, 260, 120, 80, #A48CB9, #D2C5DE, "sin");
  opButtons[13] = new Button(120, 260, 120, 80, #A48CB9, #D2C5DE, "cos");
  opButtons[14] = new Button(240, 260, 120, 80, #A48CB9, #D2C5DE, "tan");
  opButtons[15] = new Button(0, 340, 120, 80, #A48CB9, #D2C5DE, "log");
  opButtons[16] = new Button(120, 340, 120, 80, #A48CB9, #D2C5DE, "ln");
  opButtons[17] = new Button(240, 340, 120, 80, #A48CB9, #D2C5DE, "e^x");
}
