...
### Number guessing
An application that randomly chooses a number from 1 to 100 and takes in the user's guesses.![image of number guessing application](https://github.com/lucinda27/programming-portfolio/blob/gh-pages/Images/numberguessing.png?raw=true)
